...
if(NOT MSVC)
  ...
  if(ENABLE_SAPPHIRERAPIDS)
    CHECK_C_COMPILER_FLAG("-march=sapphirerapids" COMPILER_SUPPORT_SAPPHIRERAPIDS)
    if(COMPILER_SUPPORT_SAPPHIRERAPIDS)
      _AppendFlags(CMAKE_C_FLAGS -march=sapphirerapids)
      _AppendFlags(CMAKE_CXX_FLAGS -march=sapphirerapids)
    else()
      message(SEND_ERROR "Compiler cannot support flag \'-march=sapphirerapids\'.")
    endif()
  endif()

  if(ENABLE_EMERALDRAPIDS)
    CHECK_C_COMPILER_FLAG("-march=emeraldrapids" COMPILER_SUPPORT_EMERALDRAPID)
    if(COMPILER_SUPPORT_EMERALDRAPID)
      _AppendFlags(CMAKE_C_FLAGS -march=emeraldrapids)
      _AppendFlags(CMAKE_CXX_FLAGS -march=emeraldrapids)
    else()
      message(SEND_ERROR "Compiler cannot support flag \'-march=emeraldrapids\'.")
    endif()
  endif()

  if(ENABLE_GRANITERAPIDS)
    CHECK_C_COMPILER_FLAG("-march=graniterapids" COMPILER_SUPPORT_GRANITERAPIDS)
    if(COMPILER_SUPPORT_GRANITERAPIDS)
      _AppendFlags(CMAKE_C_FLAGS -march=graniterapids)
      _AppendFlags(CMAKE_CXX_FLAGS -march=graniterapids)
    else()
      message(SEND_ERROR "Compiler cannot support flag \'-march=graniterapids\'.")
    endif()
  endif()
